...
import { getVdeep } from './browser_side-compiler.js';
new CSSStyleSheet().replace(`[${getVdeep(componentId)}]>span:empty::after{content:"(empty)";}`).then(css => document.adoptedStyleSheets.push(css));
